 ...
 *  <li>Passing WSDL URL using the <code>loadWSDL</code> method</li>
...
public class SoapGen {
    ...
    /**
     *Generates the resultant SOAP request message for the first instance of specified operation in all interfaces
     *
     *@param operationName Name of the operation
     *@return Returns a String representation of the XML based SOAP request message
     *
     */
    public String generateSoapRequest(String operationName) {
    	ArrayList<String> interfaceNames = getInterfaceNames();
    	
    	for(String interfaceName : interfaceNames) {
    		String soapRequest = generateSoapRequest(interfaceName, operationName);
    		if(soapRequest != null) {
    			return soapRequest;
    		}
    	}
    ...
    public String generateSoapRequest(String interfaceName, String operationName) {
    	...
    	WsdlOperation selectedOp = getOperation(interfaceName, operationName);
    	if(selectedOp == null) {
    		return null;
    	}
        String blankSoapRequest = selectedOp.createRequest(true);
	...
	public void close() {
        ...
        for(Thread t : threadSet) {
            if(t.getName().contains("Timer") || t.getName().contains("Image Fetcher") || t.getName().contains("Thread")) {
            	System.out.println("SoapGen is closing thread: " + t.getName());
            	t.stop();
            }
        }
        /*
        ...
        for(Thread t : threadSet) {
        	System.out.println("SoapGen: Active Thead: " + t.getName());
        }
        */
    }
